...
public class ExportTransactionCustomAdapter extends RecyclerView.Adapter<ExportTransactionCustomAdapter.ViewHolderProducts> {


    private Context context;
    private List<Product> products;

    public ExportTransactionCustomAdapter(Context context, List<Product> products) {
    ...
    public ViewHolderProducts onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolderProducts(context, LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view_export_transaction, parent, false));
    }
    ...
    public class ViewHolderProducts extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            dialog.setContentView(R.layout.layout_export_transaction_details_view);
            dialog.setTitle(Constant.EXPORT_TRANSACTIONS);
            dialog.setCanceledOnTouchOutside(false);

            final EditText edittext_item,edittext_quantity,edittext_price,editText_buyer,editText_unit,editText_date;
            ...
            editText_buyer = (EditText)dialog.findViewById(R.id.buyer);
